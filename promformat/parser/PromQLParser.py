...
class PromQLParser(Parser):
    ...
    class AggregationContext(ParserRuleContext):
        ...
        def __init__(
            ...
            super().__init__(parent, invokingState)
            self.parser = parser
            self.prefix = None  # ByWithoutContext
            self.suffix = None  # ByWithoutContext
        ...
        def byWithout(self):
            return self.getTypedRuleContext(PromQLParser.ByWithoutContext, 0)
    ...
    class ByWithoutContext(ParserRuleContext):
        __slots__ = "parser"
        ...
        def getRuleIndex(self):
            return PromQLParser.RULE_byWithout

        def enterRule(self, listener: ParseTreeListener):
            if hasattr(listener, "enterByWithout"):
                listener.enterByWithout(self)

        def exitRule(self, listener: ParseTreeListener):
            if hasattr(listener, "exitByWithout"):
                listener.exitByWithout(self)

        def accept(self, visitor: ParseTreeVisitor):
            if hasattr(visitor, "visitByWithout"):
                return visitor.visitByWithout(self)
            else:
                return visitor.visitChildren(self)

    def byWithout(self):

        localctx = PromQLParser.ByWithoutContext(self, self._ctx, self.state)
    ...
    def labelNameList(self):
        ...
        self.enterRule(localctx, 66, self.RULE_labelNameList)
        self._la = 0  # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 289
